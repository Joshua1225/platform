      ...
      <el-row style="cursor : pointer " >
        <el-col :span="10" class="nick">
          <el-dropdown style="cursor : pointer" @command="handleCommand">
            <el-image style="width: 60px; height: 40px; border-radius: 100px " :src="url" :fit="fits"  @click="goUser" ></el-image>
        ...
        <el-col :span="14">
          <div class="nick" style="margin-top: 7px ; "  @click="goUser">晓之佩恩</div>
        </el-col>
      </el-row>
    </div>
  </div>
